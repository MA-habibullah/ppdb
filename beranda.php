										...
										<div class="card-body">
											...
											<div class="form-row">
                                    			<div class="form-group col-md-6">
                                                    ...
                                                    <option value=""></option><?php $qu = mysqli_query($koneksi, "select * from jenis");
                                                     while ($jenis = mysqli_fetch_array($qu)) {
                                                     ?>
                ...
                <!-- <section class="bg-light statistik" id="statistik">
                    <div class="container">
                        ...
                        <div class="row mt-12">
                            ...
                            <div class="col-sm-4">
                                <div class="card mt-2">
                                    <div class="card-header bg-success">Kuota Program Khusus</div>
                                    <div class="card-body">
                                    <?php $query = mysqli_query($koneksi, "SELECT * FROM jurusan where id_jurusan='PROGRAM KHUSUS'");
														while ($data = mysqli_fetch_array($query)) {
														?>
                                        <h2 class="text-center"><?= $data['kuota'] ?></h2>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <div class="card mt-2">
                                    <div class="card-header bg-secondary">Kuota Boarding School</div>
                                    <div class="card-body">
                                    <?php $query = mysqli_query($koneksi, "SELECT * FROM jurusan where id_jurusan='BOARDING SCHOOL'");
														while ($data = mysqli_fetch_array($query)) {
														?>
                                        <h2 class="text-center"><?= $data['kuota'] ?></h2>
                                        <?php } ?>
