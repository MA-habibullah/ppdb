        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-header-action">
                    <?php $query = mysqli_query($koneksi, "select sum(jumlah) as total from biaya where id_biaya = 1");
                    $total = mysqli_fetch_array($query);
                    ?>
                    <?php $bayar = fetch($koneksi, 'bayar', ['id_daftar' => $_SESSION['id_daftar']]);
		                if ($bayar['verifikasi'] == 1) { 
                            $query = mysqli_query($koneksi, "select sum(jumlah) as total from biaya");
                            $total = mysqli_fetch_array($query);
                        }?>
