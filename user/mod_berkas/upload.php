    ...
    <div class="card" id="berkas-card">
        ...
        <div class="card-body">
            ...
            <div class="form-group row align-items-center">
                <label class="form-control-label col-sm-3 text-md-right">Preview</label>
                <div class="col-sm-6 col-md-6">
                    <a target="_blank" href="../<?= $siswa['akta'] ?>">
                        <img src="../<?= $siswa['akta'] ?>" class="img-thumbnail" width="50%" target="_blank">
                    </a>
                </div>
            </div>
            <div class="form-group row align-items-center">
                <label class="form-control-label col-sm-3 text-md-right">Ijazah/SKL SMP</label>
                <div class="col-sm-6 col-md-9">
            ...
            <div class="form-group row align-items-center">
                <label class="form-control-label col-sm-3 text-md-right">Preview</label>
                <div class="col-sm-6 col-md-6">
                    <a target="_blank" href="../<?= $siswa['ijazah'] ?>">
            ...
            <div class="form-group row align-items-center">
                <label class="form-control-label col-sm-3 text-md-right">Preview</label>
                <div class="col-sm-6 col-md-6">
                    <a target="_blank" href="../<?= $siswa['kip'] ?>">
                        <img src="../<?= $siswa['kip'] ?>" class="img-thumbnail" width="50%">
                    </a>
                </div>
            </div>
            <div class="form-group row align-items-center">
                <label class="form-control-label col-sm-3 text-md-right">Upload Rapot 6 Semester</label>
                <div class="col-sm-6 col-md-9">

                    <div class="custom-file">
                        <input type="file" name="rapor" class="custom-file-input" id="site-rapor">
            ...
            <div class="form-group row align-items-center">
                <label class="form-control-label col-sm-3 text-md-right">Preview</label>
                <div class="col-sm-6 col-md-6">
                    <img src="../<?= $siswa['rapor'] ?>" class="img-thumbnail" width="100%" height="500px">
                    <a target="_blank" href="../<?= $siswa['rapor'] ?>"> download </a>
                </div>
            </div>
