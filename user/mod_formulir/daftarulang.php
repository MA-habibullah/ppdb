			...
			<?php if ($siswa['konfirmasi'] == 1) { ?>
				...
				<?php } else { ?>
					<div class="card-footer">
						<p>Silahkan melengkapi data formulir sesuai berkas yang dimiliki sebelum melakukan permanen data . </p>
					</div>
					<div class="card-footer">
					...
					<form id="form-konfirmasi">
						...
						<div class="form-group">
							<center><button type="submit" class="btn btn-primary btn-lg mt-2">Permanen Data</button></center>
						</div>
					</form>
				<?php } ?>
				</div>
			...
			<div class="popup-container bg-green">
				...
				<form action="" method="post" class="popup-form">
					...
					<div class="alert alert-success alert-dismissable">
						<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
						Terimakasih !!!<br />
						Data Anda Telah Berhasil <button class="badge badge-danger"> Dipermanen Pada Tanggal <?= $siswa['tgl_konfirmasi'] ?></button>
					</div>
		...
		<div class="popup-wrapper" id="popup">
			<div class="popup-container bg-green">
				...
				<form action="" method="post" class="popup-form">
					...
					<p>Silahkan Konfirmasi dan Permanen Data Jika anda Tetap Untuk Lanjut di <strong> <?= $setting['nama_sekolah'] ?> !! </strong><br />
						<strong>Jika tidak, Maka di anggap Mengundurkan Diri</strong>
					</p>
	...
	<script>
		$('#form-konfirmasi').submit(function(e) {
			...
			swal({
				...
				text: 'Akan Permanen data anda ? Data tidak dapat diubah jika sudah melakukan klik permanen data',
				icon: 'warning',
				buttons: true,
				dangerMode: true,
			}).then((result) => {
				if (result) {
					$.ajax({
						...
						success: function(data) {
							iziToast.success({
								title: 'Terimakasih!',
								message: 'Data Berhasil di Permanen',
								position: 'topRight'
							});
							setTimeout(function() {
